...
function isEphemeral(k) {
  return k.startsWith(EPHEMERAL_PREFIX);
}
 ...
 */
function adopt(brut, state, max, maxEphemeral) {
 ...
 */
function purge(state, keyPrefix) {
  let n = 0;
