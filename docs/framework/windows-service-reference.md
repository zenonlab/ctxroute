...
90** — a third party's choice, in a code path nobody here can see red. That is a NEW silent-no-restart
...
| Action | `wscript.exe "<home>\.claude\hooks\lanceurs\ctxroute-http-hidden.vbs"` |
