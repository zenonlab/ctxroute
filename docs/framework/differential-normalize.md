...
⚠️ **SINGLE SOURCE of the 2 differentials** (`porte-differential`, `mcp-differential`). Never a copy inside a suite: two normalizations diverge, and two nets that no longer filter the same thing no longer prove anything together.
