...
⚠️ PURE, mutated (mutate + Stryker include + dep-cruiser includeOnly, done 2026-08-15). The I/O shell = the `--harnais` block of doctor.js (early exit BEFORE the probes: a --harnais does not pay for 9 probes).
