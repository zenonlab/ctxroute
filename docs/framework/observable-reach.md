...
🔴 **THE EIGHT DEFECTS OF THIS PROJECT ARE THE SAME DEFECT**: ㊵ · 51 · ㊴ · ㊽ · ㊿ · 53bis · `keys` · `cwd` — **eight out of eight are holes in WHAT THE LANGUAGE CAN SEE**, not one is a hole in how it COMBINES what it sees. This file measures that axis; nothing did before.
